gap.eof.neu <- function(dat, err = c(1,1e-3), plot = TRUE, min.num = 40, max.iter = 500, keep.obs = TRUE) {
##############################################################################
...
## Optional: err         (convergence criterion within a EOF n search,  
